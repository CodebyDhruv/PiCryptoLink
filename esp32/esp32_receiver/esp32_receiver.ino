...
// ---------- User Config ----------
String WIFI_SSID = "kabali ra";
String WIFI_PASS = "nippu ra";
String PI_HOST = "192.168.137.168";
...
void loop() {
  ...
  Serial.println("⚙  Setting up cipher context...");
  sendToWebServer("⚙ Setting up cipher context...", "info");
